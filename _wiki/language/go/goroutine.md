...
* [goroutine内调用函数时会不会触发调度？](https://segmentfault.com/q/1010000002743261)
* [关于Go语言调度器实现细节的补充分析](http://blog.amalcao.me/blog/2014/05/16/guan-yu-goyu-yan-diao-du-qi-shi-xian-xi-jie-de-bu-chong-fen-xi/)
* [Go 语言对OS系统调用的处理](http://blog.amalcao.me/blog/2014/05/22/go-yu-yan-dui-osxi-tong-diao-yong-de-chu-li/)
* [Go 调度器相关数据结构](https://tiancaiamao.gitbooks.io/go-internals/content/zh/05.1.html)
* [Go语言的并发和并行](https://eleme.github.io/blog/2014/goroutine-2/)